...
import com.doubleclick.x_course.PyChat.services.FirebaseChatService;
...
public abstract class BaseActivity extends AppCompatActivity implements ServiceConnection {
    ...
    protected String[] permissionsSinch = {Manifest.permission.RECORD_AUDIO, Manifest.permission.MODIFY_AUDIO_SETTINGS, Manifest.permission.READ_PHONE_STATE,Manifest.permission.CAMERA};
...
//    private SinchService.SinchServiceInterface mSinchServiceInterface;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance("https://x-course-6e1ff-default-rtdb.firebaseio.com");//get firebase instance
