...
public class DownloadUtil {
    ...
    public void checkAndLoad(Context context, DownloadFileEvent downloadFileEvent) {
        ...
        if (file.exists()) {
            ...
            newIntent.setDataAndType(FileProvider.getUriForFile(context, context.getString(R.string.administration), file), Helper.getMimeType(context, Uri.fromFile(file)));
