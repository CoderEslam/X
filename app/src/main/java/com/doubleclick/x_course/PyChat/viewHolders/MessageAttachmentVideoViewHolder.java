...
public class MessageAttachmentVideoViewHolder extends BaseMessageViewHolder {
    ...
    public void setData(Message message, int position) {
        ...
        cardView.setCardBackgroundColor(ContextCompat.getColor(context, message.isSelected() ? R.color.darkBlue : R.color.colorBgLight));
        ll.setBackgroundColor(message.isSelected() ? ContextCompat.getColor(context, R.color.darkBlue) : isMine() ? Color.WHITE : ContextCompat.getColor(context, R.color.colorBgLight));
