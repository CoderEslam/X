...
import com.doubleclick.x_course.PyChat.fragments.ChatDetailFragment;
import com.doubleclick.x_course.PyChat.fragments.UserMediaFragment;
...
import com.doubleclick.x_course.PyChat.utils.GeneralUtils;
...
public class ChatDetailActivity extends BaseActivity implements OnUserDetailFragmentInteraction, ImagePickerCallback {
    ...
    private void setUserData() {
        ...
        Glide.with(this).load(user != null ? user.getImage() : group.getImage()).apply(new RequestOptions().placeholder(R.drawable.pychat_placeholder)).into(userImage);
