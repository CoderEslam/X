...
import com.doubleclick.x_course.PyChat.models.LogCall;
...
public class LogCallAdapter extends RecyclerView.Adapter<LogCallAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(LogCall logCall) {
            Glide.with(context).load(logCall.getUserImage()).apply(new RequestOptions().placeholder(R.drawable.pychat_placeholder)).into(userImage);
