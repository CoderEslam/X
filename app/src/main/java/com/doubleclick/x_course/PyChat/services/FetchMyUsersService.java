...
public class FetchMyUsersService extends IntentService {
    ...
    private void fetchMyUsers() {
        ...
        try {
            ...
            URL url = new URL(FirebaseDatabase.getInstance("https://x-course-6e1ff-default-rtdb.firebaseio.com").getReference().toString() + "/" + Helper.REF_USERS + ".json?auth=" + idToken);
            Toast.makeText(this, "FetchMyUsersService = "+url.toString(), Toast.LENGTH_SHORT).show();
            Log.e("FetchMyUsersService = ",""+url.toString());
