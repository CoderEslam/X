package com.doubleclick.x_course.PyChat.services;
...
import com.doubleclick.x_course.PyChat.activities.ChatActivity;
...
import com.doubleclick.x_course.PyChat.utils.FirebaseUploader;
...
public class FirebaseChatService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.e("PyChat", "onCreate");
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID_MAIN, "PyChat", NotificationManager.IMPORTANCE_LOW);
            channel.setSound(null, null);
            ((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).createNotificationChannel(channel);
        }
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID_MAIN)
                .setSmallIcon(R.drawable.pychat_logo)
    ...
    private void initVars() {
        ...
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance("https://x-course-6e1ff-default-rtdb.firebaseio.com");
    ...
    private void notifyNewGroup(Group group) {
        ...
        notificationBuilder.setSmallIcon(R.drawable.pychat_logo)
    ...
    private boolean updateUserInDb(final User user) {
        ...
        if (inDb != null && (!inDb.getImage().equals(user.getImage()) || !inDb.getStatus().equals(user.getStatus()) || !inDb.getName().equals(user.getName()))) {
            ...
            if (!TextUtils.isEmpty(myId)) {
                ...
                if (chat != null && (!chat.getChatImage().equals(user.getImage()))) {
                    rChatDb.beginTransaction();
